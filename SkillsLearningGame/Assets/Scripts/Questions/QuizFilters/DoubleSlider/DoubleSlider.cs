...
public class DoubleSlider : MonoBehaviour
{
    ...
    // Adding a last active slider to ensure it appears on top
    private SingleSlider _lastActiveSlider;
    ...
    private void Awake()
    {
        ...
        // Subscribe to OnStartDrag events of both sliders to add priority
        _sliderMin.OnStartDrag += HandleSliderStartDrag;
        _sliderMax.OnStartDrag += HandleSliderStartDrag;
    }
    private void Start()
    {
    ...
    private void HandleSliderStartDrag(SingleSlider activeSlider)
    {
        _lastActiveSlider = activeSlider;
        BringToFront(_lastActiveSlider.gameObject);
    }

    private void BringToFront(GameObject gameObject)
    {
